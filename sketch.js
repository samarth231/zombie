...
var breakButton;
function preload(){
zombieImg = loadImage("js/zombie.png")
bgdImg = loadImage("js/background.png")
}
...
function setup() {
  ...
  breakButton.mousePressed(handlePressButton)
...
function draw() {
  background(51);
  image(bgdImg,0,0,displayWidth+80,displayHeight);
